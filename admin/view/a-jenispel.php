        ...
        <div class="box box-info">
          ...
          <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                <?php $smk = mysqli_query($con, "SELECT * FROM katbenpel order by katbenpel asc ");
                $vr = 1;
                while ($akh = mysqli_fetch_array($smk)) {
                  $jben = mysqli_num_rows(mysqli_query($con, "SELECT * FROM benpel where c_katbenpel='$akh[c_katbenpel]' ")); ?>
                  <tr>
                    <td><?php echo $vr; ?></td>
                    <td><?php echo $akh['katbenpel']; ?></td>
                    <td class="text-center"><?php echo $jben; ?></td>
                    <td align="center">
                      ...
                      <a class="btn btn-warning btn-sm" data-target="#edit<?php echo $akh['c_katbenpel']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                      <a class="btn btn-danger btn-sm" data-target="#hapus<?php echo $akh['c_katbenpel']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i> Hapus</a>
                  </tr>
