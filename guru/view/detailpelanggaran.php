...
$wali = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM orangtua where c_siswa='$sea[c_siswa]' ")); ?>
<div class="judul">Hasil Pencarian Dari <?php echo $s . ' ';
                                        if ($sea == NULL) {
                                            echo 'Tidak Ada Data';
                                        } ?> </div>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <span class="pull-right">
                        <button class="btn bg-blue btn-sm" onclick="printSurat()">
    ...
    <div id="surat" style="display: none;">
        <div style="margin-bottom: 20px;">
            ...
            <div style="text-align: center; margin-bottom: 20px;">
                <h3>KOP SURAT</h3>
                <p>Alamat Sekolah</p>
                <p>No. Telepon Sekolah</p>
                <p>Email Sekolah</p>
            </div>

            <!-- Nama Siswa, Kelas, dan Hal Surat -->
            <div style="margin-bottom: 20px;">
                <p>Kepada Orang Tua/Wali Siswa,</p>
                <p>Nama Siswa: <?php echo $sea['nama']; ?></p>
                <p>Kelas: <?php echo $kelas['kelas']; ?></p>
                <p>Hal: Panggilan Rapat Terkait Pelanggaran</p>
            </div>

            <!-- Isi Surat -->
            <div style="text-align: justify;">
                <p>Dengan hormat,</p>
                <p>Dalam rangka memberikan perhatian khusus terhadap perkembangan pendidikan dan perilaku siswa, kami mengundang Anda untuk menghadiri rapat penting terkait dengan perilaku pelanggaran yang dilakukan oleh anak Anda, <?php echo $sea['nama']; ?>, siswa kelas <?php echo $kelas['kelas']; ?>.</p>
                <p>Rapat ini akan dilaksanakan pada:</p>
                <p>Tanggal: [Masukkan tanggal rapat]</p>
                <p>Waktu: [Masukkan waktu rapat]</p>
                <p>Tempat: [Masukkan tempat rapat]</p>
                <p>Kami mengharapkan kehadiran Anda dalam rapat tersebut untuk bersama-sama membahas langkah-langkah yang perlu diambil guna meningkatkan kesadaran dan tanggung jawab siswa terhadap aturan sekolah.</p>
