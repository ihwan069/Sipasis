...
if (isset($_GET['q'])) {
  ...
  $kelas = mysqli_fetch_array($poskelas);
}
?>
<div class="row">
  <!-- left column -->
  <div class="col-md-12">
    ...
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">Tambah Siswa Kelas <?php echo $kelas['kelas']; ?></h3><span style="float:right;"><a href="<?php echo $basead . 'siswa/' . $_GET['q']; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Lihat Siswa</a></span>
      </div>
      <!-- form start -->
