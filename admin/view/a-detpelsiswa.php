  ...
  <div class="col-xs-12 col-md-12 col-lg-12">
    ...
    <div class="box box-info">
      <div class="box-header  with-border">
        <h3 class="box-title">&nbsp;Seluruh Pelanggaran Siswa (<?php echo $sis['nama']; ?>)</h3>
        <p class="pull-right"><a class="btn bg-navy btn-sm" href="<?php echo $basead; ?>pelanggaransiswa"><i class="glyphicon glyphicon-list"></i> Pelanggaran Siswa</a> <a target="_blank" class="btn bg-blue btn-sm" href="<?php echo $basead . 'print/printpelsiswa?siswa=' . $_GET['q'] . ''; ?>"><i class="glyphicon glyphicon-print"></i> Print</a></p>
      </div>
      <!-- /.box-header -->
      <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-hover">
          ...
          <tbody>
            <?php $smk = mysqli_query($con, "SELECT * FROM pelanggaran where c_siswa='$_GET[q]' order by at desc ");
            $vr = 1;
            ...
            ?>
              <tr>
                ...
                <td align="center">
                  <a class="btn btn-danger btn-sm" data-target="#hapus<?php echo $akh['c_pelanggaran']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i>Hapus</a>
                </td>
              </tr>
