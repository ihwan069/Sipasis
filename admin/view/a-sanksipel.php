        ...
        <div class="box box-info">
          ...
          <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                <?php $smk = mysqli_query($con, "SELECT * FROM sanksi order by bobot_dari asc ");
                $vr = 1;
                while ($akh = mysqli_fetch_array($smk)) { ?>
                  <tr>
                    <td><?php echo $vr; ?></td>
                    <td><?php echo $akh['kriteria']; ?></td>
                    <td class="text-center"><?php echo $akh['bobot_dari'] . ' - ' . $akh['bobot_sampai']; ?></td>
                    <td align="center">
                      ...
                      <a href="<?php echo $basead; ?>editsanksi/<?php echo $akh['c_sanksi']; ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                      <a data-target="#hapus<?php echo $akh['c_sanksi']; ?>" data-toggle="modal" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-remove"></i>Hapus</a>
                  </tr>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Poin Pelanggaran <?php echo $akh['bobot_dari'] . ' - ' . $akh['bobot_sampai']; ?></p>
