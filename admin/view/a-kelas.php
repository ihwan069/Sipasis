    ...
    <div class="box box-info">
      ...
      <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-hover">
          ...
          <tbody>
            <?php $smk = mysqli_query($con, "SELECT * FROM kelas order by kelas asc ");
            $vr = 1;
            while ($akh = mysqli_fetch_array($smk)) {
              $jsis = mysqli_num_rows(mysqli_query($con, "SELECT * from siswa where c_kelas='$akh[c_kelas]' "));
              $jpe = mysqli_num_rows(mysqli_query($con, "SELECT * from pelanggaran where c_kelas='$akh[c_kelas]' "));
              $ppe = mysqli_fetch_array(mysqli_query($con, "SELECT sum(bobot) as poin from pelanggaran where c_kelas='$akh[c_kelas]' "));  ?>
              <tr>
                <td><?php echo $vr; ?></td>
                <td class="text-center"><?php echo $akh['kelas']; ?></td>
                <td class="text-center"><?php echo $jsis; ?></td>
                <td class="text-center"><?php echo $jpe; ?> Kali</td>
                <td class="text-center"><?php if ($ppe['poin'] == NULL) {
                                          echo '0';
                                        } else {
                                          echo $ppe['poin'];
                                        } ?></td>
                <td align="center">
                  ...
                  <a class="btn btn-circle btn-warning btn-sm" data-target="#edit<?php echo $akh['c_kelas']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-eye-open"></i> Edit</a>
                  <a class="btn btn-circle btn-danger btn-sm" data-target="#hapus<?php echo $akh['c_kelas']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i>Hapus</a>
                </td>
              </tr>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <b>1. Siswa Dari Kelas (<?php echo $akh['kelas']; ?>) Juga Terhapus<br>2. Pelanggaran Siswa Dari Kelas (<?php echo $akh['kelas']; ?>) Juga Terhapus</b>
                    </div>
                    <div class="modal-footer">
