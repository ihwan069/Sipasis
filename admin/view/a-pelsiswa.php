  ...
  <div class="col-xs-12 col-md-12 col-lg-12">
    ...
    <div class="box box-info">
      <div class="box-header  with-border">
        <h3 class="box-title"></span>&nbsp;Seluruh Pelanggaran Siswa</h3>
        ...
        <table id="example1" class="table table-bordered table-hover">
          <thead>
            <tr>
              <th width="1%">NO</th>
              <th>NAMA SISWA</th>
              <th width="25%">BENTUK PELANGGARAN</th>
              <th class="text-center" width="10%">POIN</th>
              <th>OLEH</th>
              <th class="text-center" width="10%">PADA</th>
              <th class="text-center">OPSI</th>
            </tr>
          </thead>
          <tbody>
            <?php $smk = mysqli_query($con, "SELECT * FROM pelanggaran order by at desc ");
            $vr = 1;
            ...
            ?>
              <tr>
                ...
                <td class="text-center"><?php echo date("d/m/Y", strtotime($akh['at'])); ?></td>
                <td align="center">
