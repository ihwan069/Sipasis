          ...
          <div class="box box-info">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php $smk = mysqli_query($con, "SELECT * FROM guru order by nama asc ");
                  $vr = 1;
                  while ($akh = mysqli_fetch_array($smk)) { ?>
                    <tr>
                      ...
                      <td align="center"><a href="<?php echo $basead; ?>editguru/<?php echo $akh['c_guru']; ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i> Edit</a>&nbsp;<a class="btn btn-danger btn-sm" data-target="#hapus<?php echo $akh['c_guru']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i></a>
                      </td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <b>1. Data Pelanggaran Siswa Yang Diinputkan Oleh (<?php echo $akh['nama']; ?>) Secara Keseluruhan Juga Terhapus</b>
                          </div>
