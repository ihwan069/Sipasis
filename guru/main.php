...
$na = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM guru where c_guru='$_SESSION[c_guru]' ")); //$setting=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM setting limit 1 ")); 
?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <script type=" text/javascript" src="<?php echo $basead; ?>main/js/jquery.js">
  </script>
...
<body class="skin-purple hold-transition fixed" oncontextmenu="return false">
  <!--modal ganti foto-->
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu text">
          <p class="navi text-center">MAIN NAVIGATION</p>
          <li <?php echo $aak; ?>>
          ...
          <li <?php echo $bak; ?>>
            <a href="<?php echo $basegu; ?>inputpelanggaran">
              <i class="glyphicon glyphicon-ok text-black"></i> <span class="text-black">Input Pelanggaran</span>
            </a>
          </li>
          <li <?php echo $cak; ?>>
            <a href="<?php echo $basegu; ?>sanksi">
              <i class="glyphicon glyphicon-list-alt text-black"></i> <span class="text-black">Sanksi Pelanggaran</span>
            </a>
          </li>
          <li>
            <a href="<?php echo $basegu; ?>history">
              <i class="glyphicon glyphicon-calendar text-black"></i> <span class="text-black">History</span>
            </a>
          </li>
        </ul>
      </section>
