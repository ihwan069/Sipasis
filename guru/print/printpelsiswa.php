<?php
require 'PPS/guru/php/config.php';
require 'PPS/guru/php/function.php';
session_start();
if (empty($_SESSION['c_guru'])) {
  header('location:' . $base . '');
}
require_once("PPS/guru/master/dompdf/dompdf_config.inc.php");
...
$smk = mysqli_query($con, "SELECT * FROM pelanggaran where c_siswa='$_GET[siswa]' order by at desc ");
$vr = 1;
